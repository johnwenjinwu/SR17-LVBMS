...
/* Private defines -----------------------------------------------------------*/
#define Batt_XRST_Pin GPIO_PIN_1
#define Batt_XRST_GPIO_Port GPIOC
#define Batt_XALERT_Pin GPIO_PIN_2
#define Batt_XALERT_GPIO_Port GPIOC
#define Batt_XALERT_EXTI_IRQn EXTI2_IRQn
...
#define CHG_INT_Pin GPIO_PIN_2
#define CHG_INT_GPIO_Port GPIOA
